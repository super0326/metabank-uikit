...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "5px" }, isPushed ? (React.createElement(Icon$d, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$e, { width: "24px", color: "textSubtle" }))),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://poocoin.app/tokens/0x18fd1312E055c63322A0dfb466DBDC24234AA9EC", target: "_blank" },
        React.createElement(Icon$X, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(4)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, banner: banner },
...
var ThemeSwitcher = function (_a) {
    ...
    return (React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { padding: '0 10px' } },
        React.createElement(Flex, { alignItems: "center" }, isDark ?
            React.createElement(SunIcon, { color: "text", width: "24px" }) :
            React.createElement(MoonIcon, { color: "text", width: "24px" }))));
};
...
var Menu$1 = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { banner: banner ? true : false, isPushed: isPushed, isMobile: isSmallerScreen, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
            React.createElement(Inner, { isPushed: isPushed, showMenu: showMenu, height: totalTopMenuHeight }, children),
