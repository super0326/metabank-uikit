...
var Icon$1c = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 75 47" }, props),
        React__default['default'].createElement("image", { width: "75", height: "47", href: '/darklogo.png' })));
};
...
var Icon$$ = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 200 200" }, props),
        React__default['default'].createElement("image", { width: "200", height: "200", href: '/darklogo.png' })));
};
...
var Icon$X = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: "90", height: "90", href: '/darklogo.png' })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default['default'].createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default['default'].createElement(Icon$1t, { color: "success" }) : React__default['default'].createElement(Icon$1w, { color: "success" }) }, children));
};
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$_, { color: props.color ? props.color : "success", ml: "4px" })));
};
...
var templateObject_1$w, templateObject_2$i, templateObject_3$a, templateObject_4$6, templateObject_5$4, templateObject_6$2, templateObject_7$2;
...
var templateObject_1$s, templateObject_2$f, templateObject_3$7, templateObject_4$3, templateObject_5$1, templateObject_6$1, templateObject_7$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#F4F4F4", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#2b2a2f", textDisabled: "#6f6e6d", textSubtle: "#333231", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "rgb(20, 22, 59);", backgroundDisabled: "#3c3742", backgroundAlt: "#14163b", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default['default'].createElement(Icon$1s, { color: "button" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 55" }, props),
        React__default['default'].createElement("image", { width: "160", height: "55", href: '/images/darklogo.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "5px" }, isPushed ? (React__default['default'].createElement(Icon$d, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$e, { width: "24px", color: "textSubtle" }))),
...
var socials = [
    {
        ...
        items: [
            ...
            {
                label: "Announcements",
                href: "ttps://t.me/ibullswapofficial",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/ibullswap",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://poocoin.app/tokens/0x18fd1312E055c63322A0dfb466DBDC24234AA9EC", target: "_blank" },
        React__default['default'].createElement(Icon$X, { width: "24px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(4)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    ...
    var mr = index < socials.length - 1 ? "15px" : 0;
    if (social.items) {
...
var StyledPanel = styled__default['default'].div(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100%;\n  transition: padding-top 0.2s, width 0.2s cubic-bezier(0.4, 0, 0.2, 1);\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  ", ";\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100%;\n  transition: padding-top 0.2s, width 0.2s cubic-bezier(0.4, 0, 0.2, 1);\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  ", ";\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n"])), function (_a) {
    var showMenu = _a.showMenu, banner = _a.banner;
    return (showMenu ? (banner ? "140px" : "80px") : 0);
}, function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
}, function (_a) {
...
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, banner = props.banner;
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, banner: banner },
...
var ThemeSwitcher = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { padding: '0 10px' } },
        React__default['default'].createElement(Flex, { alignItems: "center" }, isDark ?
            React__default['default'].createElement(SunIcon, { color: "text", width: "24px" }) :
            React__default['default'].createElement(MoonIcon, { color: "text", width: "24px" }))));
};
...
var Menu$1 = function (_a) {
    var _b;
    var userMenu = _a.userMenu, banner = _a.banner; _a.globalMenu; var isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { banner: banner ? true : false, isPushed: isPushed, isMobile: isSmallerScreen, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu, height: totalTopMenuHeight }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
var templateObject_1$9, templateObject_2$4, templateObject_3$1, templateObject_4, templateObject_5, templateObject_6, templateObject_7;
